...
for (var i = 0; i < fullTrip.length - 1; i++) {
    var journey1 = fullTrip[i];
    var journey2 = fullTrip[i + 1];
  
    (function (journey1, journey2) { // Create a new scope using a closure
      var journeyButton = document.createElement("button");
      journeyButton.innerHTML = journey1.city + " to " + journey2.city + " date: " + new Date(journey1.departureDate);
      journeyButton.addEventListener("click", async function () {
